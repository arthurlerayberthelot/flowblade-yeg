...
CLIP_TEXT_COLOR = (0.9, 0.9, 0.9)
CLIP_TEXT_COLOR_OVERLAY = (0.9, 0.9, 0.9, 0.8)

CLIP_COLOR_GRAD = (1, 0.25, 0.25, 0.25, 1)
CLIP_COLOR_GRAD_L = (0, 0.25, 0.25, 0.25, 1)
CLIP_SELECTED_COLOR = (0.45, 0.45, 0.45)
CLIP_END_DRAG_OVERLAY_COLOR = (1, 1, 1, 0.3)

AUDIO_CLIP_COLOR_GRAD = (1, 0.18, 0.18, 0.18, 1)
AUDIO_CLIP_COLOR_GRAD_L = (0, 0.18, 0.18, 0.18, 1)
AUDIO_CLIP_SELECTED_COLOR = (0.38, 0.38, 0.38)

IMAGE_CLIP_COLOR_GRAD = (1, 0.30, 0.30, 0.30, 1)
IMAGE_CLIP_COLOR_GRAD_L = (0, 0.30, 0.30, 0.30, 1)
IMAGE_CLIP_SELECTED_COLOR = (0.50, 0.50, 0.50)

TITLE_IMAGE_CLIP_COLOR_GRAD = (1, 0.35, 0.35, 0.35, 1)
TITLE_IMAGE_CLIP_COLOR_GRAD_L = (0, 0.35, 0.35, 0.35, 1)
TITLE_IMAGE_CLIP_SELECTED_COLOR = (0.55, 0.55, 0.55)

CONTAINER_CLIP_NOT_RENDERED_COLOR = (0.22, 0.22, 0.22)
CONTAINER_CLIP_NOT_RENDERED_SELECTED_COLOR = (0.40, 0.40, 0.40)
CONTAINER_CLIP_RENDERED_COLOR = (0.28, 0.28, 0.28)
CONTAINER_CLIP_RENDERED_SELECTED_COLOR = (0.48, 0.48, 0.48)

COMPOSITOR_CLIP = (0.15, 0.15, 0.15, 0.7)
COMPOSITOR_CLIP_AUTO_FOLLOW = (0.20, 0.20, 0.20, 0.65)
COMPOSITOR_CLIP_SELECTED = (0.50, 0.50, 0.50, 0.8)

 # Set in load_icons_and_set_colors().
BLANK_CLIP_COLOR_GRAD = None
BLANK_CLIP_COLOR_GRAD_L = None

BLANK_CLIP_COLOR_SELECTED_GRAD = (1, 0.40, 0.40, 0.40, 1)
BLANK_CLIP_COLOR_SELECTED_GRAD_L = (0, 0.40, 0.40, 0.40, 1)

SINGLE_TRACK_TRANSITION_SELECTED = (0.60, 0.60, 0.60)

SYNC_OK_COLOR = (0.5, 0.5, 0.5)
SYNC_OFF_COLOR = (0.8, 0.8, 0.8)
SYNC_GONE_COLOR = (0.3, 0.3, 0.3)

PROXY_STRIP_COLOR = (0.45, 0.45, 0.45)
PROXY_STRIP_COLOR_SELECTED = (0.60, 0.60, 0.60)

MARK_COLOR = (0.1, 0.1, 0.1)
DARK_MARK_COLOR = (0.75, 0.75, 0.75)
MARK_OUTLINE = (0.8, 0.8, 0.8)

FRAME_SCALE_COLOR_GRAD = (1, 0.15, 0.15, 0.15, 1)
FRAME_SCALE_COLOR_GRAD_L = (0, 0.15, 0.15, 0.15, 1)

FRAME_SCALE_SELECTED_COLOR_GRAD = (0, 0.25, 0.25, 0.25, 1)
FRAME_SCALE_SELECTED_COLOR_GRAD_L = (1, 0.25, 0.25, 0.25, 1)

SELECTED_RANGE_COLOR = (0.5, 0.5, 0.5, 0.35)

DARK_FRAME_SCALE_SELECTED_COLOR_GRAD = (0, 0.20, 0.20, 0.20, 1)
DARK_FRAME_SCALE_SELECTED_COLOR_GRAD_L = (1, 0.20, 0.20, 0.20, 1)

ICON_SELECTED_OVERLAY_COLOR = (0.8, 0.8, 0.8, 0.3)
...
FRAME_SCALE_LINES = (0.6, 0.6, 0.6)
FRAME_SCALE_TEXT = (0.7, 0.7, 0.7)

BG_COLOR = (0.08, 0.08, 0.08)
FRAME_SCALE_NEUTRAL_BG_COLOR = (0.10, 0.10, 0.10)
THEME_NEUTRAL_COLUMN_BG_COLOR = (0.12, 0.12, 0.12)

COLUMN_NOT_ACTIVE_COLOR = (0.15, 0.15, 0.15)
COLUMN_ACTIVE_COLOR = (0.50, 0.50, 0.50)

OVERLAY_COLOR = (0.9, 0.9, 0.9)
OVERLAY_SELECTION_COLOR = (0.9, 0.9, 0.9)
CLIP_OVERLAY_COLOR = (0.5, 0.5, 0.5, 0.5)
OVERWRITE_OVERLAY_COLOR = (0.2, 0.2, 0.2, 0.5)
INSERT_MODE_COLOR = (0.9, 0.9, 0.9)
OVERWRITE_MODE_COLOR = (0.7, 0.7, 0.7)
OVERLAY_TRIM_COLOR = (0.8, 0.8, 0.8)
OVERLAY_TRIM_OVERWRITE_COLOR = (0.6, 0.6, 0.6)
BOX_BOUND_COLOR = (0.8, 0.8, 0.8, 0.3)
TRIM_MAX_RED = (0.9, 0.9, 0.9)

POINTER_TRIANGLE_COLOR = (0.7, 0.7, 0.7, 0.7)
SHADOW_POINTER_COLOR = (0.4, 0.4, 0.4)

MATCH_FRAME_LINES_COLOR = (0.7, 0.7, 0.7)

BLANK_SELECTED = (0.40, 0.40, 0.40)

TRACK_NAME_COLOR = (0.8, 0.8, 0.8)
...
Y_SCROLL_BG = (0.06, 0.06, 0.06)

DARK_THEME_COLUMN_BG = (0.10, 0.10, 0.10)
...
class TimeLineFrameScale:
    ...
    def _draw(self, event, cr, allocation):
        ...
        # Draw small tick lines and tc texts.
